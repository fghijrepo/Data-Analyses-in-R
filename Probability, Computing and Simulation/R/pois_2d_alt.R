# This is a competitor for the original implementation.
...
# this implementation differ from the Simulation book in the way 
...
#' This implementation assigns the x-coordinates from a uniform distribution.
#' 
...
#'
#' @examples
#' pois_2d_alt(10, 100, 0.01)
pois_2d_alt <- function(b, h, lambda) {
